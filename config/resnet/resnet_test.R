...
###
### The datafile is:
setwd("/home/agre/aurora_bayes_nonparametric_inference/package")
datafile <- '../data/resnet18_1703078471_15000_classwise.csv'
...
buildmetadata(data=alldata, file='../data/meta-resnet')
...
###
### (See 'meta-resnet-modified.csv' for the resulting modifications)
...
inferpopulation(data=alldata[trainpoints], metadata='../data/meta-resnet-modified.csv', outputdir='../output_files/testresnet', nsamples=mcsamples, nchains=2)
...
outputdir <- paste0('../output_files/testresnet-V8-D', ntrain, '-K64-S', mcsamples)
...
pdff(paste0('../results/resnet/testresult1-V8-D', ntrain, '-K64-S', mcsamples)) # open a pdf for plotting
## plot samples first
...
## for y=0,...,5
## and compare them with the prediction that was made by the Resnet
##
...
pdff(paste0('../results/resnet/testresult2-V8-D', ntrain, '-K64-S', mcsamples))
##
for(i in testpoints){
    ## get Resnet weights
